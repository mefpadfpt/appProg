...
<head>
	...
	<!-- Favicon -->
	<link href="<?php echo e(asset('template/img/favicon.ico')); ?>" rel="shortcut icon" />
	...
	<link rel="stylesheet" href="<?php echo e(asset('template/css/themify-icons.css')); ?>" />
	...
	<link rel="stylesheet" href="<?php echo e(asset('template/css/owl.carousel.css')); ?>" />
...
<body>
	...
	<header class="header-section">
		<div class="container">
			<!-- logo -->
			<a href="/acceuil" class="site-logo"><img src="<?php echo e(asset('template/img/ministere.png')); ?>" width="35%" alt=""></a>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="<?php echo e(asset('template/img/hero-slider/Capture1.png')); ?>">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								...
								<div class="btn text-white" style="background-color:rgb(246, 120, 58);"><a href="#about">MFPA?</a></div>
							</div>
						</div>
					</div>
				</div>
			</div>
			<div class="hs-item set-bg" data-setbg="<?php echo e(asset('template/img/FOND.jpg')); ?>">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
		...
		<div class="mt-5 mb-3 text-center">
			<h3 style="font-family: 'Source Sans Pro', sans-serif;" id="about"> MFPA</h3>
				...
				<div class="testimonial-slider owl-carousel">
					<div class="ts-item">
						<div class="row">
							...
							<div class="col-md-9 ts-text" style="font-family: 'Times New Romans', sans-serif;">
					...
					<div class="ts-item">
						<div class="row">
							...
							<div class="col-md-9 ts-text" style="font-family: 'Times New Roman', sans-serif;">
			...
			<div class="row">
				...
				<div class="col-sm-4 col-lg-4 footer-widget">
					<div class="about-widget">
						<img src="<?php echo e(asset('template/img/ministere.png')); ?>" alt="">
				...
				<div class="col-sm-4 col-lg-4 footer-widget">
					...
					<div class="dobule-link">
						<ul>
							...
							<li><a href="<?php echo e(route('programme')); ?>">Nos Programmes</a></li>
	...
	<script src="<?php echo e(asset('template/js/jquery.countdown.js')); ?>"></script>
	<script src="<?php echo e(asset('template/js/masonry.pkgd.min.js')); ?>"></script>
	<script src="<?php echo e(asset('template/js/magnific-popup.min.js')); ?>"></script>
	<script src="<?php echo e(asset('template/js/main.js')); ?>"></script>

</body>

</html><?php /**PATH /var/www/appProg/resources/views/pages/acceuil.blade.php ENDPATH**/ ?>