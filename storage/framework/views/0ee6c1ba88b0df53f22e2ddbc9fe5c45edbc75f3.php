...
<div class="container">
  ...
  <form class="col-md-12 col-lg-10 offset-1" action="<?php echo e(route('store.programme')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="NOM">Programme/metier</label>
...
<div class="form-group " >
        ...
        <select name="secteur_id" id="id" class="form-control">
          ...
          <option value="<?php echo e($sect->id); ?>"><?php echo e($sect->TYPE); ?></option>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/appProg/resources/views/programme/add.blade.php ENDPATH**/ ?>