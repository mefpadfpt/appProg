...
<body>
 ...
 <div class="content">
  ...
  <div class="block">
   ...
   <?php endif; ?>
  <marquee><h1 class="text-center" style="color:rgb(246, 120, 58);">Principaux projets financés par les partenaires au developement du pays </h1></marquee>
     ...
     <table class="table table-bordered table-striped table-vcenter">
      <thead style="color:rgb(246, 120, 58);">
       <tr>
        <th>Projet</th>
        <th >Périodes</th>
        <th colspan="2" class="bordered" style="text-align: center;">Sources de financement
         <table class="table">
          <tr>
        ...
        <th style="text-align: center;">Zones d'intervention</th>
      ...
      <tbody>
       ...
       <tr>
        <td style="width: =50px;"><?php echo e($projets->NOMProjet); ?></td>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/appProg/resources/views/admin/listProjet.blade.php ENDPATH**/ ?>