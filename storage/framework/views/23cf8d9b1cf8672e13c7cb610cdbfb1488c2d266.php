...
<div>
  ...
  <h4 class="text-center pt-2" style="color:rgb(246, 120, 58);">Remplisser les informations par programmes et par niveaux de votre etablissement</h4>
...
unset($__errorArgs, $__bag); ?></p>
    ...
    <div class="row mt-3">
      <div class="col">
        ...
        <input type="text" class="form-control" name="anne_niv" placeholder="2000-2001" >
...
unset($__errorArgs, $__bag); ?></p>
  ...
  <div class="row">
       <div class="col">
        ...
        <input type="text" class="form-control" name="anne_aca"placeholder="1e année" >
...
unset($__errorArgs, $__bag); ?></p>
    ...
    <!--div class="row">
       <div class="col">
        <label for="anne_aca">Classe Pédagogique </label>
        <input type="text" class="form-control" name="anne_aca"placeholder="2e année" >
        <?php $__errorArgs = ['anne_aca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></p>
    ...
    <div class="row">
       <div class="col">
        <label for="anne_aca">Classe Pédagogique </label>
        <input type="text" class="form-control" name="anne_aca"placeholder="3e année" >
        <?php $__errorArgs = ['anne_aca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.backend1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/appProg/resources/views/user/RenseignerEta.blade.php ENDPATH**/ ?>