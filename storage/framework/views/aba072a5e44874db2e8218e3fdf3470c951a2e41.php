...
<body>
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            <!-- Hero -->
            <div class="bg-image" style="background-image: url('<?php echo e(asset('template/img/FOND.jpg')); ?>');">
                        ...
                        <div class="content content-full text-center">
                            ...
                            <span class="m-2 d-inline-block invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="600">
                                <a class="btn btn-success px-4 py-2" data-toggle="click-ripple" href="/acceuil">
                                    <i class="fa fa-fw fa-home mr-1"></i> Accueil
                                </a>
                            </span>
                            <span class="m-2 d-inline-block invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="600">
                ...
                <div class="content py-5">
                    <div class="row font-size-sm">
                        ...
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="" target="_blank">Copyright</a> &copy; <span data-toggle="year-copy"></span> Ministre de l’Emploi, de la Formation professionnelle et de l’Artisanat
                        </div>
                    </div>
                </div>
            </footer>
...
</html><?php /**PATH /var/www/appProg/resources/views/index.blade.php ENDPATH**/ ?>