...
unset($__errorArgs, $__bag); ?></p>
   ...
   <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" id="PERIODE" name="PERIODE" placeholder="2000-2001">
...
unset($__errorArgs, $__bag); ?></p>
  ...
  <div class="form-group">
   <label for="NOM">Types d'intervation/Activités</label>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/appProg/resources/views/admin/projets.blade.php ENDPATH**/ ?>