...
unset($__errorArgs, $__bag); ?></p>
            ...
            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                ...
                <div class="">
                    <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>"placeholder="xyz@adresse.com">
...
unset($__errorArgs, $__bag); ?></p>
            ...
            <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                ...
                <div class="">
                    <input id="password" type="password" class="form-control" name="password"placeholder="Mettre le password de votre choix">
...
unset($__errorArgs, $__bag); ?></p>
            ...
            <div class="form-group<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                ...
                <div class="">
                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation"placeholder="Confirmez le password choisi">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/appProg/resources/views/utilisateur/auth/register.blade.php ENDPATH**/ ?>